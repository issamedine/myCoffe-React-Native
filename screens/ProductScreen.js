      ...
      <View className={`space-y-3 ${ios? 'mb-6': 'mb-3'}`}>
          <View className="flex-row justify-between items-center px-4 mb-2">
              ...
              <View 
                ...
                <TouchableOpacity  onPress={()=> {countOfProduct > 1 && setCountOfProduct(countOfProduct -1)}}>
                  <MinusIcon size="20" strokeWidth={3} color={themeColors.text} />
                </TouchableOpacity>
                <Text style={{color: themeColors.text}} className="font-extrabold text-lg">{countOfProduct}</Text>
                <TouchableOpacity onPress={()=> setCountOfProduct(countOfProduct + 1)}>
